...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <link rel="stylesheet" href="./admin_file/assets/css/sitemap.min.css"/>
            </head>
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    <div class="flex items-center">
                        <h1 class="ma0 mr2 f2 green">Sitemap</h1>
                    ...
                    <h2 class="ma0 mt4 f4 normal">
                        <xsl:choose>
                            <xsl:when test="sitemap:sitemapindex">
                                This index contains
                                <strong class="green"><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong>
                                sitemaps.
                            </xsl:when>
                            <xsl:otherwise>
                                This index contains
                                <strong class="green"><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong>
                                URLs.
                            </xsl:otherwise>
                        </xsl:choose>
                    </h2>
                    <p>
                        ...
                        You can find more information about XML sitemaps on <a href="https://sitemaps.org" class="link green">sitemaps.org</a>.
                    </p>
                </header>
                ...
                <footer class="mw8 center pv4 tc">
                    This is sitemap generated by <a href="./tool/xml-sitemap-generator/" title="Go to Github" class="link green">Tool Kits PRO - XML Sitemap Generator</a> online tool, created by <a href="https://sureshchand.com.np" title="Suresh Chand" class="link green">Suresh Chand</a>
                </footer>
    ...
    <xsl:template match="xhtml:link">
        ...
        <p>
            <strong>Xhtml: </strong>
            <a href="{$altloc}" class="mr2 link green">
                <xsl:value-of select="@href"/>
            </a>
    ...
    <xsl:template match="image:image">
        ...
        <p>
            <strong>Image: </strong>
            <a href="{$loc}" class="mr2 link green">
                <xsl:value-of select="image:loc"/>
            </a>
