<style>
.rgb-to-hex-converter_content .rgb_font {
    font-size: 16px;
    color: #222;
    width: 60px;
}

.rgb-to-hex-converter_content .rgb_input,
.rgb-to-hex-converter_content .rgb_input:focus {
    width: 72px;
    height: 26px;
    font-size: 14px;
...
.rgb-to-hex-converter_content input.form-range {
...
<div class="rgb-to-hex-converter_content">
    <div class="rgb-to-hex-converter_submit_form">
