$(document).ready(function(){
    ...
    $(document).on("submit", ".youtube-hashtag-extractor_submit_form", function(e){
        e.preventDefault();

        const form = $(this);
        const btn = form.find("[type=submit]");
        const report = form.find(".youtube-hashtag-extractor_report");
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function () {
                show_loadingModal("Extracting Hash Tags . . .");
