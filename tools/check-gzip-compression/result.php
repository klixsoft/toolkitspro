<div class="row mx-0 mt-3">
    <div class="col-12 px-0">
        <div class="alert alert-success">Congratulation! You have GZIP compression enabled on server to achieve maximum compression on your website.</div>
    </div>
    ...
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="col p-4 border">
                ...
                <div>
                    <div class="fw-bold">Compressed size</div>
    ...
    <div class="col-md-4 text-center">
        <?php
            echo get_svg_circle(@$result->percentage, 120, 4, "success", true);
        ?>
        <p class="mt-2"><em>Was saved by compressing this webpage with GZIP.</em></p>
    </div>
</div>