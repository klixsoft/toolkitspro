...
.html-encoder_copy.active .modal__actions-button-copied,
.html-encoder_download.active .modal__actions-button-copied {
    transform: translateY(0%);
}

.html-encoder_copy,
.html-encoder_download {
    color: var(--primary);
}

.html-encoder_copy i,
.html-encoder_download i {
    font-size: 18px;
}
...
.html-encoder_report textarea#html-encoder_result {
    border-radius: 0;
}
...
<div class="json-to-xml-converter_content">
    ...
    <div class="button-row text-center mt-4 mb-3">
        <button type="button" class="btn btn-primary encodeHTMLCode">Encode HTML Code</button>
    </div>


    <div class="form-group">
        <label>Result</label>
        <div class="html-encoder_report_container">
            <div class="html-encoder_report">
                <textarea id="html-encoder_result" disabled rows="8" class="form-control scrollbar"></textarea>
                <div class="modal__actions">
                    <div class="modal__actions-helper">
                        Encoded HTML Result <code>result.html</code>
                    </div>
                    <div class="footer_button_row">
                        <button type="button" class="modal__actions-button html-encoder_copy">
                            <i class="las la-code"></i>
                            <span>Copy</span>
                            <div class="modal__actions-button-copied js-copied">Copied!</div>
                        </button>

                        <button type="button" class="modal__actions-button html-encoder_download">
