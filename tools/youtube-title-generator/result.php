<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">Click on a titles you like if you want to temporarily store it in the box below.
            </div>

            <div class="card-body">
                <?php
                    foreach( $output as $tag ){
                        echo sprintf('<span class="yt_tags d-block">%s</span>', $tag);
                    }
                ?>
            </div>
        </div>
...
<div class="form-group mt-4">
    ...
    <div class="modal__actions">
        <div class="modal__actions-helper">
            Youtube Tags <code>titles.txt</code>
        </div>
