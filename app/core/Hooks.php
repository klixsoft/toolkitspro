...
final class Hooks implements \Iterator, \ArrayAccess {
    ...
    public function add_filter($hook_name, $callback, $priority, $accepted_args) {
        $idx = ast_filter_build_unique_id($hook_name, $callback, $priority);
    ...
    public function remove_filter($hook_name, $callback, $priority) {
        $function_key = ast_filter_build_unique_id($hook_name, $callback, $priority);
    ...
    public function has_filter($hook_name = '', $callback = false) {
        ...
        $function_key = ast_filter_build_unique_id($hook_name, $callback, false);
    ...
    /**
     * Normalizes filters set up before AllSmartTools has initialized to Hooks objects.
     *
